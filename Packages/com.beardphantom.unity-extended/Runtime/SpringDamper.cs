...
static float damper_exponential(
    float x, 
    float g, 
    float damping, 
    float dt, 
...
static float damper_implicit(float x, float g, float halflife, float dt, float eps=1e-5f)
{
...
public static void spring_damper_bad(
    float& x,
    float& v, 
    float g,
    float q, 
...
public static void spring_damper_implicit(
    float& x, 
    float& v, 
    float x_goal, 
    float v_goal, 
...
public static float critical_spring_damper_implicit(
    float x, 
    ref float v, 
    float x_goal, 
    float v_goal, 
...
public static float decay_spring_damper_implicit(
    float x, 
    ref float v, 
    float halflife, 
    float dt)
